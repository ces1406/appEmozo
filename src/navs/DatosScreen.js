...
class DatosScreen extends Component {
            ...
            <View>
                <ImageBackground source={require('../imgs/cena2.jpg')} style={{width: '100%', height: '100%'}}>
                    <View style={{flex:1, alignItems:'center',justifyContent:'center',backgroundColor:'rgba(32,41,48,0.7)'}}>
                        <Text style={estiloLocal.contenido1}>DATOS DEL USUARIO</Text>
                        <Text style={estiloLocal.contenido1}>(NOMBRE, PASS, MAIL, ALGUN OTRO?)</Text>
                    </View>
                </ImageBackground>
            </View>
        );
